...
<div class="tutor-single-course-segment">
    <div class="course-student-rating-title">
        <h4 class="tutor-segment-title"><?php _e('Student Feedback', 'kitolms'); ?></h4>
    </div>
    <div class="tutor-course-reviews-wrap">
            ...
            <div class="course-avg-rating-wrap">
                <div class="tutor-row tutor-align-items-center">
                    <div class="tutor-col-auto">
                        ...
                        <p class="tutor-course-avg-rating-total">Total <span><?php echo esc_html($rating->rating_count);?></span> Ratings</p>
                        ...
                        <div class="course-ratings-count-meter-wrap">
							...
							foreach ($rating->count_by_value as $key => $value){
                                ...
                                <div class="course-rating-meter">
                                    ...
                                    <div class="rating-meter-col"><?php echo esc_html($key); ?></div>
                                    <div class="rating-meter-col rating-meter-bar-wrap">
                                        <div class="rating-meter-bar">
                                            <div class="rating-meter-fill-bar" style="width: <?php echo esc_html($rating_count_percent); ?>%;"></div>
                                        </div>
                                    </div>
                                    <div class="rating-meter-col rating-text-col">
                                        <?php
                                        echo esc_html($value).' ';
                                        echo esc_html($value) > 1 ? __('ratings', 'kitolms') : __('rating', 'kitolms'); ?>
                                    </div>
                                </div>
							<?php } ?>
                        </div>
        ...
        <div class="tutor-course-reviews-list">
			...
			foreach ($reviews as $review){
				...
				?>
                <div class="tutor-review-individual-item tutor-review-<?php echo esc_html($review->comment_ID); ?>">
                    <div class="review-left">
                        ...
                        <div class="tutor-review-user-info">
                            <div class="review-time-name">
                                <p> <a href="<?php echo esc_url($profile_url); ?>">  <?php echo esc_html($review->display_name); ?> </a> </p>
                                <p class="review-meta">
                                    <?php echo sprintf(__('%s ago', 'kitolms'), human_time_diff(strtotime($review->comment_date))); ?>
                                </p>
                            </div>
