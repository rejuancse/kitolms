...
<div class="woocommerce-form-coupon-toggle">
	<?php wc_print_notice( apply_filters( 'woocommerce_checkout_coupon_message', esc_html__( 'Have a coupon?', 'kitolms' ) . ' <a href="#" class="showcoupon">' . esc_html__( 'Click here to enter your code', 'kitolms' ) . '</a>' ), 'notice' ); ?>
</div>
